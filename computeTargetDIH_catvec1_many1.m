...
try
    load(sprintf('cache/catvec1_many1_data_m%d.mat',m));
catch
    ...
    save(sprintf('cache/catvec1_many1_data_m%d.mat',m),'drugs_train','lab_train',...
        'cond_train','proc_train','los_train','spec_train','place_train',...
        'drugs_test','lab_test','cond_test','proc_test','los_test',...
