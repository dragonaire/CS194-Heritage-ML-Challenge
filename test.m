...
load('f3.mat');
load('f4.mat');
[yr3_pred] = computeTargetDIH_svm2(ages.yr2,genders.yr2,logDIH.yr2,...
...
[target.DIH] = computeTargetDIH_svm2(ages.yr3,genders.yr3,logDIH.yr3,target.ages,target.genders,...
