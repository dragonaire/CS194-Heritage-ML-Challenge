...
load('f3.mat');
load('f4.mat');
[yr3_pred] = computeTargetDIH_ens2(ages.yr2,genders.yr2,logDIH.yr2,...
...
[target.DIH] = computeTargetDIH_ens2(ages.yr3,genders.yr3,logDIH.yr3,target.ages,target.genders,...
...
load('f3.mat');
load('f4.mat');
[yr3_pred] = computeTargetDIH_factor2(ages.yr2,genders.yr2,logDIH.yr2,...
    fake_target.ages,fake_target.genders,drugs.features2_1yr,drugs.features3_1yr,...
    lab.features2_1yr,lab.features3_1yr,f2.condGroup,f3.condGroup,...
    f2.procedure,f3.procedure,f2.specialty,f3.specialty,...
    f2.place,f3.place,drugs.extrafeatures2,drugs.extrafeatures3,...
...
indices = 1:31;
[yr3_pred,yr3_weights] = meanRidgeRegression(all_yr3_pred, yr3_var,...
    yr3_opt_const, yr3_rmse, 1.0, indices);
yr3_pred = postProcess(yr3_pred);
