...
load('f4.mat');
for seed=124:130
    %for LAMBDA = [5e-7,10e-7,20e-7,40e-7,80e-7,150e-7,300e-7,500e-7,1e-4]
    for LAMBDA = [2,5,10,20,50,2e-4,5e-4,1e-3,2e-3,5e-3,1e-2,2e-2,5e-2,1e-1,2e-1,5e-1,1]
        [yr3_pred] = computeTargetDIH_factor4(ages.yr2,genders.yr2,logDIH.yr2,...
            ...
            f2.extraPcpProvVend,f3.extraPcpProvVend,f2.extraCG,f3.extraCG,LAMBDA,seed:seed);
        yr3_pred = postProcess(yr3_pred);
        err = sqrt(mean((log(DIH.yr3+1)-log(yr3_pred+1)).^2));
        disp(sprintf('TEST ERROR %f',err));
        [target.DIH] = computeTargetDIH_factor4(ages.yr3,genders.yr3,logDIH.yr3,target.ages,target.genders,...
            ...
            f3.extraPcpProvVend,f4.extraPcpProvVend,f3.extraCG,f4.extraCG,LAMBDA,seed:seed);
    end
end
return
load('f2.mat');
