function [target_DIH] = computeTargetDIH_ens3(ages,genders,logDIH,...
...
NMODELS = 1;
try
  load(sprintf('cache/ens3_m%d_NMODELS%d.mat', m, NMODELS));
catch
  ens = fitensemble(A,logDIH,'LSBoost', NMODELS,'KNN')
  save(sprintf('cache/ens3_m%d_NMODELS%d.mat', m, NMODELS), 'ens');
end
